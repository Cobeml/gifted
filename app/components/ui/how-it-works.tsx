    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-black mb-4 font-heading">
            How It Works
          </h2>
          <p className="text-base sm:text-lg text-neutral-800 mb-12 font-body">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 relative z-10 max-w-7xl mx-auto">
          {features.map((feature, index) => (
            <div
              key={feature.title}
              className={`flex flex-col lg:border-r py-6 sm:py-8 lg:py-10 relative group/feature
            ...
            >
              ...
              <div className="mb-3 sm:mb-4 relative z-10 px-6 sm:px-8 lg:px-10 text-neutral-600">
                {feature.icon}
              </div>
              <div className="text-base sm:text-lg font-bold mb-2 relative z-10 px-6 sm:px-8 lg:px-10">
                ...
                <span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-800 font-heading">
                  {feature.title}
                </span>
              </div>
              <p className="text-xs sm:text-sm text-neutral-600 max-w-xs relative z-10 px-6 sm:px-8 lg:px-10 font-body">
                {feature.description}
              </p>
            </div>
          ))}
